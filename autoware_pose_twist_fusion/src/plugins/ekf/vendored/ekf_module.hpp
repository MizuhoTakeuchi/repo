...
//
// Vendored from autoware_ekf_localizer (src/ekf_module.hpp) without algorithmic changes.
...
#ifndef EKF_VENDORED__EKF_MODULE_HPP_
#define EKF_VENDORED__EKF_MODULE_HPP_
...
#endif  // EKF_VENDORED__EKF_MODULE_HPP_
