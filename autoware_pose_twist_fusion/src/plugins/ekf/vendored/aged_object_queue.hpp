...
//
// Vendored from autoware_ekf_localizer (src/include/aged_object_queue.hpp) without changes
// other than the namespace and the header guard. See design_last.md §5.1.

#ifndef EKF_VENDORED__AGED_OBJECT_QUEUE_HPP_
#define EKF_VENDORED__AGED_OBJECT_QUEUE_HPP_
...
#endif  // EKF_VENDORED__AGED_OBJECT_QUEUE_HPP_
