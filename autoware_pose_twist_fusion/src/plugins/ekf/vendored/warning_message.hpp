...
//
// Vendored from autoware_ekf_localizer (src/warning_message.hpp) without algorithmic changes.
...
#ifndef EKF_VENDORED__WARNING_MESSAGE_HPP_
#define EKF_VENDORED__WARNING_MESSAGE_HPP_
...
#endif  // EKF_VENDORED__WARNING_MESSAGE_HPP_
