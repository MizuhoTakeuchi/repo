...
//
// Vendored from autoware_ekf_localizer (src/warning.hpp) without algorithmic changes.
...
#ifndef EKF_VENDORED__WARNING_HPP_
#define EKF_VENDORED__WARNING_HPP_
...
#endif  // EKF_VENDORED__WARNING_HPP_
