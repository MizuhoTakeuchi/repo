...
//
// Vendored from autoware_ekf_localizer (src/matrix_types.hpp) without algorithmic changes.
...
#ifndef EKF_VENDORED__MATRIX_TYPES_HPP_
#define EKF_VENDORED__MATRIX_TYPES_HPP_
...
#endif  // EKF_VENDORED__MATRIX_TYPES_HPP_
