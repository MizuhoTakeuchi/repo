...
//
// Vendored from autoware_ekf_localizer (src/state_index.hpp) without algorithmic changes.
...
#ifndef EKF_VENDORED__STATE_INDEX_HPP_
#define EKF_VENDORED__STATE_INDEX_HPP_
...
#endif  // EKF_VENDORED__STATE_INDEX_HPP_
